...
function initDb(callback) {
    ...
    _db.serialize(function() {
      ...
      _db.run('INSERT OR IGNORE INTO customer(cellphone, name, address, dlicense) VALUES '
      + '(3434, "Stepan", "100 Homer", "AAAAAA")');

      _db.run('INSERT OR IGNORE INTO rentals(vid, cellphone, fromDate, fromTime, toDate, toTime,'
      + 'odometer, cardName,cardNo, expDate) VALUES '
      + '(1, 3434, "2019-10-10", "10-00", "2019-10-12", "1O-00", 10, "Stepan Card", 1, "2021-10-12")');
